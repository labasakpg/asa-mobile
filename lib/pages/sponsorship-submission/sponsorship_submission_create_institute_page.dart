...
class SponsorshipSubmissionCreateInstitutePage extends StatelessWidget {
  final c = Get.put(SponsorshipCreateController());

  SponsorshipSubmissionCreateInstitutePage({
    Key? key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    c.init(EmployeeStakeHolderStateConverter.toLabel(
      EmployeeStakeHolderState.institute,
    ));
    ...
    return AppbarWrapper(
      ...
      customeAppBarFlexibleSpace: AppBarBuilder.buildBasicAppbar(
        label: "Buat Sponsorship Perusahaan",
  ...
  List<Widget> _buildChildren(BuildContext context) {
    return [
      _buildFormsInstitute(context),
    ];
  }

  Widget _buildFormsInstitute(BuildContext context) {
    return Obx(
      () {
