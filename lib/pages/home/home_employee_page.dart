...
import 'package:anugerah_mobile/widgets/home_page/employee_menu_home_page.dart';
import 'package:anugerah_mobile/widgets/home_page/news_section_home_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class HomeEmployeePage extends StatelessWidget implements AppHomeBase {
  HomeEmployeePage({super.key});
  ...
  List<Widget> children(BuildContext context) => [
        PageHelper.buildGap(),
        EmployeeMenuHomePage(),
        PageHelper.buildGap(50),
        NewsSectionHomePage(showViewAllButton: true),
      ];
